#!/usr/bin/env python3
"""
Vault Reindex Script - Fast version without embeddings (or optional async embeddings)
"""
...
def build_search_index(vault_path: Path) -> Dict[str, Any]:
    """Build the complete search index for the vault (no embeddings for speed)."""
...
def main():
    print("=" * 60)
    print("VAULT REINDEX STARTED (Fast Mode)")
    print("=" * 60)
